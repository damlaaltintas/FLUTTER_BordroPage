...
class _BordroCardDetailsState extends State<BordroCardDetails>
  ...
  List<Widget> buildBoxCategories2() {
...
Widget buildTabBar() {
  List<Widget> categoryWidgets = [];
  final List<String> tabs = <String>['Tab 1', 'Tab 2', 'Tab3', 'Tab4',];
